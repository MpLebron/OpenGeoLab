...
} = require('../db/applicationSchemesRepository.js')
...
test('PyGeoModel local application seed maps to scheme summary and detail records', () => {
  ...
  assert.equal(
    mapApplicationSchemeSummaryResponse(summary).links.case,
    'https://mybinder.org/v2/gh/MpLebron/PyGeoModel-Case/main?urlpath=/doc/tree/code.ipynb'
  )
