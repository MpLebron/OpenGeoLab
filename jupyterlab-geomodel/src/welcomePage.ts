    ...
    this.node.innerHTML = `
      <div class="welcome-container">
        ...
        <div class="welcome-cards">
          <div class="welcome-card welcome-card-developing" data-command="geomodel:open-agent">
            ...
            <div class="welcome-card-title-row">
              ...
              <span class="welcome-card-badge">Developing</span>
            </div>
            <div class="welcome-card-desc">Experimental modeling assistant for testing. Core workflows are available in Resources and notebooks.</div>
          </div>
          ...
          <div class="welcome-card" data-command="filebrowser:activate">
            <div class="welcome-card-icon">
    ...
    cards.forEach((card) => {
      card.addEventListener('click', () => {
        ...
        if (command && this._app.commands.hasCommand(command)) {
          void this._app.commands.execute(command);
        } else if (command === 'filebrowser:activate' && this._app.commands.hasCommand('filebrowser:toggle-main')) {
          void this._app.commands.execute('filebrowser:toggle-main');
        }
      });
    });
  }
